...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-gray-900 dark:text-gray-100 flex items-center justify-center min-h-screen p-6">
        <div class="w-full max-w-2xl mx-auto text-center">
            <div class="mb-8 flex justify-center">
                <div class="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/25">
                    <svg class="w-10 h-10 sm:w-12 sm:h-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <p class="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-10 leading-relaxed">
                Simplify your mess operations — manage members, track expenses, plan meals, and stay organized effortlessly.
            </p>

            @if (Route::has('login'))
                <a href="{{ route('login') }}"
                   class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold px-8 py-3.5 sm:px-10 sm:py-4 rounded-xl shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-200 text-base sm:text-lg">
                    Get Started
            ...
            <p class="mt-8 text-xs sm:text-sm text-gray-400 dark:text-gray-600">
