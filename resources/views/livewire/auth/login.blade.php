    ...
    <div class="w-full max-w-sm mx-auto">
        ...
        <form wire:submit="authenticate" class="space-y-5">
            <div>
                ...
                <input type="email" wire:model.blur="email" id="email" autofocus
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 text-sm text-gray-600">
                    <input type="checkbox" wire:model="remember" class="rounded border-gray-300 text-gray-900 focus:ring-gray-900">
                    Remember me
                </label>
            </div>
        ...
        <p class="text-center text-sm text-gray-500 mt-8">
            ...
            <a href="{{ route('register') }}" wire:navigate class="font-medium text-gray-900 hover:underline">Register</a>
        </p>
    </div>
</div>
